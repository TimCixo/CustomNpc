...
var GIT_LOADER_ITEM_NAME = "Загрузчик NPC из GitHub";
...
function init(event) {
    ...
    mcStack.set(GitLoaderInit_DataComponents.LORE, new GitLoaderInit_ItemLore(buildLore([
        "ПКМ по воздуху открывает интерфейс загрузки.",
        "Вставь URL репозитория или папки GitHub.",
        "Загруженный код кэшируется для текущего предмета.",
        "ПКМ по NPC записывает загруженные скрипты."
    ])));
