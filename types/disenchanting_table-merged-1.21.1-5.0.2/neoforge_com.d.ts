declare module 'neoforge.com.cursee.disenchanting_table.client' {
  class ClientConfig {
...
declare module 'neoforge.com.cursee.disenchanting_table.client.gui.screens' {
  import { ItemCombinerScreen, AbstractContainerScreen } from 'net.minecraft.client.gui.screens.inventory';
  import { DisenchantingMenu, DisenchantingTableMenu } from 'neoforge.com.cursee.disenchanting_table.core.world.inventory';
...
declare module 'neoforge.com.cursee.disenchanting_table.client.network.packet' {
  import { NeoForgeConfigSyncS2CPacket, NeoForgeItemSyncS2CPacket } from 'neoforge.com.cursee.disenchanting_table.core.network.packet';
  import { IPayloadContext } from 'net.neoforged.neoforge.network.handling';

  class NeoForgeConfigSyncClientHandler {
    static handle(packet: NeoForgeConfigSyncS2CPacket, context: IPayloadContext): void;
  }


  class NeoForgeItemSyncClientHandler {
    static handle(packet: NeoForgeItemSyncS2CPacket, context: IPayloadContext): void;
  }

}

declare module 'neoforge.com.cursee.disenchanting_table.client.renderer.blockentity' {
  import { BlockEntityRenderer } from 'net.minecraft.client.renderer.blockentity';
  import { DisenchantingTableBlockEntity } from 'neoforge.com.cursee.disenchanting_table.core.world.block.entity';
...
declare module 'neoforge.com.cursee.disenchanting_table' {
  ...
  class DisenchantingTableClientNeoForge {
    constructor(modEventBus: IEventBus);
  }


  class DisenchantingTableNeoForge {
  ...
  class DisenchantingTableServerNeoForge {
...
declare module 'neoforge.com.cursee.disenchanting_table.core' {
  class CommonConfig {
    static onLoad(): void;
  }
...
declare module 'neoforge.com.cursee.disenchanting_table.core.network' {
  ...
  class NeoForgeNetwork {
    static handleConfigSyncPacketOnServer(packet: NeoForgeConfigSyncS2CPacket, context: IPayloadContext): void;
    static handleItemSyncPacketOnServer(packet: NeoForgeItemSyncS2CPacket, context: IPayloadContext): void;
    static init(): void;
    static register(event: RegisterPayloadHandlersEvent): void;
    static sendToPlayer<MSG extends CustomPacketPayload>(player: ServerPlayer, message: MSG): void;
    static sendToServer<MSG extends CustomPacketPayload>(message: MSG): void;
  }

}

declare module 'neoforge.com.cursee.disenchanting_table.core.registry' {
...
declare module 'neoforge.com.cursee.disenchanting_table.core.util' {
...
declare module 'neoforge.com.cursee.disenchanting_table.core.world.block' {
...
declare module 'neoforge.com.cursee.disenchanting_table.core.world.block.entity' {
  import { ExposedSimpleInventoryBlockEntity } from 'neoforge.com.cursee.disenchanting_table.core.world.block.entity.util';
...
declare module 'neoforge.com.cursee.disenchanting_table.core.world.block.entity.util' {
...
declare module 'neoforge.com.cursee.disenchanting_table.core.world.inventory' {
...
declare module 'neoforge.com.cursee.disenchanting_table.mixin' {
...
declare module 'neoforge.com.cursee.disenchanting_table.platform' {
  import { IPlatformHelper } from 'neoforge.com.cursee.disenchanting_table.platform.services';
  import { ServerPlayer } from 'net.minecraft.server.level';
...
declare module 'neoforge.com.cursee.disenchanting_table.platform.services' {
  import { ServerPlayer } from 'net.minecraft.server.level';
  import { NonNullList, BlockPos } from 'net.minecraft.core';
  import { ItemStack, CreativeModeTab } from 'net.minecraft.world.item';
  import { BlockEntityType, BlockEntity } from 'net.minecraft.world.level.block.entity';
